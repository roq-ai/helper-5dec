...
export function TaskListPage(props: TaskListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getTasks({
        relations: ['project', 'user', 'update.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('user', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('update', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'update',
          header: 'Update',
          accessorKey: 'update',
          cell: ({ row: { original: record } }: any) => record?._count?.update,
        }
      : null,
